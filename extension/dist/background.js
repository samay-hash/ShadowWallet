...
async function handleMessage(msg, sender) {
  ...
  switch (msg.type) {
    ...
    case "ACTIVATE_SHADOW": {
      ...
      state.sessions.unshift({ ...keypair, tabId: (_a = sender.tab) == null ? void 0 : _a.id });
    ...
    case "ANALYZE_TRANSACTION": {
      ...
      const result = await callAnalyze(transaction, siteUrl, (_b = state.shadowWallet) == null ? void 0 : _b.publicKey);
